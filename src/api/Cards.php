...
class Cards
{
    ...
    public static function w5i(): object
    {
        return (object)[
            ...
            '5' => new Card('4', Card::MIDDLE),
            '6' => new Card('6', Card::MIDDLE),
            '7' => new Card('8', Card::MIDDLE),
            '8' => new Card('10', Card::MIDDLE),
            '9' => new Card('12', Card::MIDDLE),
            '10' => new Card('16', Card::MIDDLE),
            '11' => new Card('20', Card::HIGH),
            '12' => new Card('24', Card::HIGH),
            '13' => new Card('30', Card::HIGH),
            '14' => new Card('40', Card::HIGH),
            '15' => new Card('60', Card::HIGH),
            '16' => new Card('?', Card::UNKNOWN),
            '17' => new Card('break', Card::UNKNOWN),
        ];
    }
